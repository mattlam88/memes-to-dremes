...
class Ui_TweetStream(object):
    def setupUi(self, TweetStream):
        ...
        TweetStream.setMinimumSize(QtCore.QSize(415, 1000))
        TweetStream.setMaximumSize(QtCore.QSize(16777215, 16777215))
        TweetStream.setAutoFillBackground(False)
        self.layoutWidget = QtWidgets.QWidget(TweetStream)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 391, 1000))
        ...
        self.tweetStream.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.tweetStreamScrollAreaContents.setGeometry(QtCore.QRect(0, 0, 351, 740))
        ...
        self.followingInfluencers.setMinimumSize(QtCore.QSize(0, 150))
        self.followingInfluencers.setMaximumSize(QtCore.QSize(16777215, 150))
        self.followingInfluencers.setObjectName("followingInfluencers")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.followingInfluencers)
        ...
        self.influencers.setGeometry(QtCore.QRect(0, 0, 351, 130))
        self.influencers.setObjectName("influencers")
        self.followingInfluencersScrollArea.setWidget(self.influencers)
        self.verticalLayout_4.addWidget(self.followingInfluencersScrollArea)
